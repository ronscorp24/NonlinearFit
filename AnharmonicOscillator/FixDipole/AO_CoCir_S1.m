...
%%
Fig12 = figure(12);
set(Fig12,'Units', 'Normalized', 'OuterPosition', [0 0 1 1]);
subplot(2,4,1);
plot(EmiAxis,AbsHSlice1,EmiAxis,Fit8a,'-g');
title('Co-cir Hor');
subplot(2,4,2);
plot(AbsAxis,AbsVSlice1,AbsAxis,Fit8b,'-g');
title('Co-cir Ver');
subplot(2,4,3);
plot(ExDiagF1,ExDiagSlice1,ExDiagF1,Fit8c,'-g');
title('Co-cir Diag');
subplot(2,4,4);
plot(ExXDiagF1,ExXDiagSlice1,ExXDiagF1,Fit8d,'-g');
title('Co-Cir X-diag');
subplot(2,4,5);
plot(EmiAxis,RealHSlice1,EmiAxis,Fit8e,'-g');
title('Co-cir Hor:Real');
subplot(2,4,6);
plot(AbsAxis,RealVSlice1,AbsAxis,Fit8f,'-g');
title('Co-cir Ver:Real');
subplot(2,4,7);
plot(ExXDiagF1,ExRealXDiagSlice1,ExXDiagF1,Fit8g,'-g');
title('Co-Cir X-diag:Real');
